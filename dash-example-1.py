...
df = pd.read_csv('https://raw.githubusercontent.com/Kirti26T/data/master/gdp-life-exp-2007.csv')
df2 = pd.read_csv('https://raw.githubusercontent.com/Kirti26T/data/master/usa-agricultural-exports-2011.csv')
